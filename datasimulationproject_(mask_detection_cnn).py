# -*- coding: utf-8 -*-
"""DataSimulationProject (mask_detection_CNN).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1PoLsSIaHT2sdAj5G4aqmNnLF9G7UBH-t
"""
...
img = mpimg.imread('/content/drive/MyDrive/data/with_mask/with_mask_3093.jpg')
imgplot = plt.imshow(img)
plt.show()

# displaying without mask image
img = mpimg.imread('/content/drive/MyDrive/data/without_mask/without_mask_1000.jpg')
imgplot = plt.imshow(img)
plt.show()
